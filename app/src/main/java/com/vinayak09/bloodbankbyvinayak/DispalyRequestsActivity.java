...
public class DispalyRequestsActivity extends AppCompatActivity {
    ...
    private void updateBloodRequest(boolean b) {
        ...
        FirebaseDatabase.getInstance("https://madlabproject-17edc-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Donors").child(uid).updateChildren(hashMap);
    }
}